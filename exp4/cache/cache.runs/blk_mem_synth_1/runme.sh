...
HD_PWD='C:/Users/Wufisher/Desktop/work/cs_riscv_exp/exp4/cache/cache.runs/blk_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem.tcl
